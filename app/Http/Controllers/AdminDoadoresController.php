<?php namespace App\Http\Controllers;
	...
	class AdminDoadoresController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form = [];
			$this->form[] = ['label'=>'Mensageiro Id','name'=>'mensageiro_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'colaboradores,nome_completo'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Mensageiro Id","name"=>"mensageiro_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"mensageiro,id"];
			//$this->form[] = ["label"=>"Nome Completo","name"=>"nome_completo","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Nome Recibo","name"=>"nome_recibo","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:doadores","placeholder"=>"Por favor digite um endereço de e-mail válido"];
			...
			//$this->form[] = ["label"=>"Periodicidade","name"=>"periodicidade","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Situacao","name"=>"situacao","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Dia Pgto","name"=>"dia_pgto","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Obs Financeiras","name"=>"obs_financeiras","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Obs Pessoais","name"=>"obs_pessoais","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			//$this->form[] = ["label"=>"Obs Gerais","name"=>"obs_gerais","type"=>"textarea","required"=>TRUE,"validation"=>"required|string|min:5|max:5000"];
			# OLD END FORM
