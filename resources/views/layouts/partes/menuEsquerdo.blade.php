    ...
    <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="fa fa-dollar-sign"></i><span class="hide-menu">Financeiro </span></a>
        <ul aria-expanded="false" class="collapse  first-level">
            <li class="sidebar-item"><a href="#" class="sidebar-link"><i class="fa fa-arrow-right"></i><span class="hide-menu"> Pagar </span></a></li>
            <li class="sidebar-item"><a href="#" class="sidebar-link"><i class="fa fa-arrow-left"></i><span class="hide-menu">Receber </span></a></li>
            <li class="sidebar-item"><a href="#" class="sidebar-link"><i class="fa fa-pen-square"></i><span class="hide-menu"> Cobrança </span></a></li>
        </ul>
    </li>
