    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8 order-md-1">
          <h4 class="mb-3">Informações do Doador</h4>
          <form class="needs-validation" novalidate>
            ...
            <div class="mb-3">
              <label for="username">Nome de usuário <span class="text-muted">(Opcional)</span></label>
              <div class="input-group">
                <div class="input-group-prepend">
                  <span class="input-group-text">@</span>
                </div>
                <input type="text" class="form-control" id="username" placeholder="Opcional" required>
            ...
            <div class="custom-control custom-checkbox">
              ...
              <label class="custom-control-label" for="same-address">Confirmar algum tipo de informação</label>
            </div>
            <div class="custom-control custom-checkbox">
              <input type="checkbox" class="custom-control-input" id="save-info">
              <label class="custom-control-label" for="save-info">Salvar os dados para uma proxima vez</label>
            </div>
            <hr class="mb-4">

            <h4 class="mb-3">Como você vai realizar a doação?</h4>
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                ...
                <small class="text-muted">Nome do Dono do cartão</small>
                <div class="invalid-feedback">
            ...
            <hr class="mb-4">
            <button class="btn btn-success btn-lg btn-block" type="submit">Confirmar Pagamento</button>
          </form>
        </div>
      </div>
