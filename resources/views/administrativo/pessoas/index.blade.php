            ...
            <div class="d-flex m-t-10 justify-content-end">              
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                    <div class="chart-text m-r-10">
                        <h4 class="m-b-0"><small>Colaboradores</small></h4>
                        <center><h4 class="m-t-0 text-info">0</h4> </center>
                    </div>
                </div>
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                    <div class="chart-text m-r-10">
                        <h4 class="m-b-0"><small>Voluntários</small></h4>
                        <center><h4 class="m-t-0 text-primary">0</h4> </center>
                    </div>
                </div>
            </div>
        </div> 
